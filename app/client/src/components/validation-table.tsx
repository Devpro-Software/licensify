...
type Props = {
    licenseId?: string
    trackerId?: string
    excludeTrackerColumn?: boolean
}

export function ValidationTable(props: Props) {
    const recentValidations = useRecentValidations(props.licenseId, props.trackerId)
                ...
                <Table>
                    ...
                    <TableHeader>
                        <TableRow>
                            ...
                            {!props.excludeTrackerColumn && <TableHead className="">Tracker</TableHead>}
                    ...
                    <TableFooter>
                        <TableRow>
                            <TableCell className="text-center bg-none" colSpan={props.excludeTrackerColumn ? 6 : 7}>
