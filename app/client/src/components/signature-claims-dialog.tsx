    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
                ...
                <DialogDescription>License Claims are client side data that are added to individual license signatures, and can help power some use cases (e.g. product tiers).</DialogDescription>
                {showWarning &&
                    <Alert>
